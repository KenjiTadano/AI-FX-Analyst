...
export function TradeJournal({ userId, view, pair, quote, analysis, initialBalance }: { userId: string; view: "analysis" | "trades" | "performance"; pair: string; quote: Quote | null; analysis: AIAnalysis | null; initialBalance: number }) {
  ...
  async function save(draft: TradeDraft): Promise<string | null> {
    ...
    setEditor(null); setError(null); setMessage("クラウドへ保存しました。"); return null;
  }
